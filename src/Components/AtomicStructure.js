...
const AtomicStructure = ({selectedElement}) => {
  ...
  return (
    <div className="container">
      <div className='p_orbital' id='p7_orbit'>
        ...
        <div className='d_orbital' id='d6_orbit'>
          ...
          <div className='f_orbital' id='f5_orbit'>
            ...
            <div className='s_orbital' id='s7_orbit'>
              ...
              <div className='p_orbital' id='p6_orbit'>
                ...
                <div className='d_orbital' id='d5_orbit'>
                  ...
                  <div className='f_orbital' id='f4_orbit'>
                    ...
                    <div className='s_orbital' id='s6_orbit'>
                      ...
                      <div className='p_orbital' id='p5_orbit'>
                        ...
                        <div className='d_orbital' id='d4_orbit'>
                          ...
                          <div className='s_orbital' id='s5_orbit'>
                            ...
                            <div className='p_orbital' id='p4_orbit'>
                              ...
                              <div className='d_orbital' id='d3_orbit'>
                                ...
                                <div className='s_orbital' id='s4_orbit'>
                                  ...
                                  <div className='p_orbital' id='p3_orbit'>
                                    ...
                                    <div className='s_orbital' id='s3_orbit'>
